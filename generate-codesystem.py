...
def build_hierarchical_codesystem(db_path: str) -> Dict:
    ...
    codesystem = {
        ...
        "property": [
            ...
            {"code": "effDate", "type": "string", "description": "Group effective date"},
            ...
            {"code": "secondaryHospShare", "type": "decimal", "description": "Hospital share (secondary)"},
            {"code": "secondaryProfShare", "type": "decimal", "description": "Professional share (secondary)"},
            {"code": "pcfAmount", "type": "decimal", "description": "PCF payment amount"},
            {"code": "pcfHospShare", "type": "decimal", "description": "Hospital share (PCF)"},
            {"code": "pcfProfShare", "type": "decimal", "description": "Professional share (PCF)"},
            ...
            {"code": "checkFacilityMat", "type": "boolean", "description": "MAT (Maternity) eligibility"},
            {"code": "checkFacilityFsdc", "type": "boolean", "description": "FSDC eligibility"},
            {"code": "checkFacilityAbtc", "type": "boolean", "description": "ABTC eligibility"},
            {"code": "checkFacilityOpmc", "type": "boolean", "description": "OPMC eligibility"},
            {"code": "checkFacilityPcb", "type": "boolean", "description": "PCB eligibility"},
            {"code": "checkFacilityRhu", "type": "boolean", "description": "RHU eligibility"},
            {"code": "checkFacilityTbdotsc", "type": "boolean", "description": "TBDOTSC eligibility"},
            {"code": "checkFacilityTsekap", "type": "boolean", "description": "TSEKAP eligibility"},
            {"code": "checkFacilityDatrc", "type": "boolean", "description": "DATRC eligibility"},
            {"code": "checkFacilityHivth", "type": "boolean", "description": "HIVTH eligibility"},
            {"code": "checkFacilityFpc", "type": "boolean", "description": "FPC eligibility"},
            {"code": "checkFacilityCiu", "type": "boolean", "description": "CIU eligibility"},
            {"code": "checkFacilityDsp", "type": "boolean", "description": "DSP eligibility"},
            {"code": "checkPcfSecondaryCr", "type": "boolean", "description": "PCF secondary case rate check"},
            {"code": "checkAscSecondaryCr", "type": "boolean", "description": "ASC secondary case rate check"},
            {"code": "ruleEffDate", "type": "string", "description": "Rule effective date"},
            {"code": "ruleEndDate", "type": "string", "description": "Rule end date"},
        ],
